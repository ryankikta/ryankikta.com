	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( 0 === strcasecmp( $item->attr_title, 'divider' ) && 1 === $depth ) {
				...
				$item_output .= ( $args->has_children && 0 === $depth ) ? ' <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="13" height="8" viewBox="0 0 13 8"><path style="fill:none;stroke:#361181;stroke-width:2.5;stroke-miterlimit:10;" d="M11.3,0.9L6.1,5.8L0.9,0.9"/></svg></a>' : '</a>';
