	...
	<div class="container-fluid">
		<div class="row">
			<div class="col text-center d-none d-lg-block">
				<h2 class="fs3">Why choose to launch</h2>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4 membership-sidebar text-center mb-5 mb-lg-0 mr-lg-3 py-40 collapse" id="membershipSidebar">
                <img width="149px" src="<?php echo CLOUD_URL_Assets; ?>/uploads/solutions/membership_launch.svg">
                <h2 class="mt-3">Launch</h2>
                <div class="d-flex justify-content-center mt-3">
                    <div class="text-left">
                        ...
                        <ul>
                            <li>No Saved Sale Products</li>
                        </ul>
                        <h2 class="fs3">ORDER/SHIPPING</h2>
                        <ul>
                            <li>Bulk Orders $0.99 fee</li>
                        </ul>
                        <h2 class="fs3">DESIGN</h2>
                        <ul>
                            <li>Design Tool</li>
                            <li>Licensed Images $9.95*</li>
                        </ul>
            ...
            <div class="col-12 col-lg-7 mt-lg-5">
                <h2 class="fs1">HEADER FOR LAUNCH HERE</h2>
                <h2>SUBHEADER FOR WHY CHOOSE LAUNCH HERE</h2>
                <?php atlas(); ?>
