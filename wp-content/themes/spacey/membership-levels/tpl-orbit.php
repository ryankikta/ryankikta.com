	...
	<div class="container">
		<div class="row align-items-center text-center">
            <div class="col-6 col-lg-2 offset-lg-2 mb-lg-3 d-flex justify-content-end justify-content-lg-center">
                <img width="150px" src="<?php echo CLOUD_URL_Assets; ?>/uploads/solutions/membership_orbit.svg">
            </div>
            <div class="col-6 col-lg-1 d-flex justify-content-start">
                <div class="text-center">
                    <h1 class="fs2">Orbit</h1>
                    <!-- <span class="badge">Best Value</span> -->
                </div>
            </div>
            <div class="col-12 col-lg-6 ml-lg-5 text-center text-lg-left mt-4 mt-lg-0">
                <h2 class="fs1">$9.95<span> / per month</span></h2>
            </div>
        </div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col text-center d-none d-lg-block">
				<h2 class="fs3">Why choose to build an orbit</h2>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4 membership-sidebar text-center mb-5 mb-lg-0 mr-lg-3 py-40 collapse" id="membershipSidebar">
                <img width="149px" src="<?php echo CLOUD_URL_Assets; ?>/uploads/solutions/membership_orbit.svg">
                <h2 class="mt-3">ORBIT</h2>
                <div class="d-flex justify-content-center mt-3">
                    <div class="text-left">
                        ...
                        <ul>
                            <li>PrintCash Rewards 1%</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-7 mt-lg-5">
                <h2 class="fs1">HEADER FOR ORBIT HERE</h2>
                <h2>SUBHEADER FOR WHY CHOOSE ORBIT HERE</h2>
                <?php atlas(); ?>
