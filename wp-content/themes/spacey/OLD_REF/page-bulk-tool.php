...
<div class="container-fluid py-40">
    ...
    <div id="importOrderStepTwo" class="row align-items-center justify-content-center justify-content-lg-between">
        <div class="col-12 col-lg-6 py-40">
            ...
            <p>Your file <b>must</b> contain only one record per line, and the first record <b>must</b> consist of field names that map subsequent records to our system. That is to say, the first row in your file should be the column names.</p>
            <p>The Ryan Kikta field/column names, in no particular order, are:</p>
            <ul>
                <li><b>sku</b>: Your inventory identifier for the product, unique for each product.</li>
                <li><b>title</b>: The product's displayed name.</li>
                <li><b>description</b>: The product's displayed description. HTML is allowed.</li>
                <li><b>brand</b>: Brand name.</li>
                <li><b>product</b>: Product name.</li>
                <li><b>colors</b>: Comma-separated color names.</li>
                <li><b>normal_price</b>: Price for standard sizes.</li>
                <li><b>plus_price</b>: Price for plus sizes.</li>
                ...
                <li>storeimages: Comma-separated list of image file names to use for your storefront. The first image on the list is used as the main image. If this isn't given then it defaults to using <i>front_mockup</i> and <i>back_mockup</i> (if those are given).</li>
                <li><b>weight</b>: Product weight.</li>
                <li><b>tags</b>: Product tags.</li>
            </ul>
            <div class="bs-callout bs-callout-info">
                <ul>
                    <li><b>Bold</b> fields are required.</li>
                    <li><a href="https://ryankikta.com/csv-help/" target="_blank">A table of available brands, products, and colors is available here.</a></li>
                    <li>Brand names, their SKUs, and colors are not case sensitive.</li>
                    <li>Unknown or empty fields are ignored.</li>
                    <li>Image file names should exactly match those in the <a href="https://ryankikta.com/upload-images/" target="_blank">Ryan Kikta image manager</a>.</li>
                </ul>
            </div>
            ...
            <p class="mt-3">By default we skip over records seen as duplicates of existing products (based on your SKU). This is convenient when resuming a partial import. However, you can change this behavior so that the existing products are overwritten with the new information.</p>
            <div class="input_checkbox my-3">
                <input type="checkbox" name="clobber" id="PA-clobber" value="1" />
                <label for="PA-clobber">Update existing products when encountered.</label>
            </div>
            <div class="btn btn-primary">Import CSV to Ryan Kikta</div>
        </div>
    </div> <!-- content-wrapper -->
</div>
<?php get_footer();?>
