...
class Client
{
    ...
    public static function listHook($filter = false)
    {
        $filter = Filter::create($filter);
        return self::getCollection('/hooks/' . $filter->toQuery());
    }
    ...
    public static function getHook($id)
    {
    ...
    public static function createHook($object)
    {
    ...
    public static function updateHook($id, $object)
    {
    ...
    public static function deleteHook($id)
    {
    ...
    {
        return self::deleteResource('/products/' . $id . '/images');
    }
    ...
    public static function getProductsPage($page_index = 1)
    {
        return self::connection()->get(self::$api_path . '/products?limit=250&page=' . $page_index);
    }
    ...
    public static function updateOptions($id, $object)
    {
        return self::updateResource('/options/' . $id, $object);
    }

    public static function createOptionsValue($id, $object)
    {
        return self::createResource('/options/' . $id . '/values', $object);
    }
    ...
    public static function getOption_byid($id)
    {
        return self::getResource('/options/' . $id, 'Option');
    }
    ...
    public static function deleteOptionValues($id)
    {
        return self::deleteResource('/options/' . $id . '/values');
    }
    ...
    {
        return self::deleteResource('/options/' . $option_id . '/values/' . $id, 'OptionValue');
    }

    public static function getOptionValues($id)
    {
        return self::getCollection('/options/' . $id . '/values?limit=250');
    }

    public static function getProductOptionValues($id)
    {
    ...
    {
        $filter = Filter::create($filter);
        $cats = self::getCollection('/categories' . $filter->toQuery(), 'Category');
        $all_cats = array();
        foreach ($cats as $key => $cat) {
            if ($cat->parent_id == 0) {
                $all_cats[] = array('id' => $cat->id,
                    'name' => $cat->name);
            }
        }
        foreach ($cats as $key => $cat) {
            if ($cat->parent_id != 0) {
                foreach ($all_cats as $ind => $val) {
                    if ($cat->parent_id == $val['id']) {
                        $all_cats[$ind]['child'][] = array('id' => $cat->id,
                            'name' => $cat->name);
                        break;
                    }
                }
    ...
    {
        return self::getCollection('/orders/' . $id . '/products', 'Product');
    }

    public static function getOrderShipments($id)
    {
        return self::getCollection('/orders/' . $id . '/shipments', 'Shipment');
    }

    public static function createOrderShipments($id, $object)
    {
        return self::createResource('/orders/' . $id . '/shipments', $object);
    }
    ...
    public static function getOptionSets_byid($id)
    {
    ...
    public static function updateOptionsets($id, $object)
    {
        return self::updateResource('/optionsets/' . $id, $object);
    }

    public static function deleteOptionsets($id)
    {
    ...
    public static function ListSkus($product_id, $sku)
    {
        return self::getCollection('/products/' . $product_id . '/skus?sku=' . $sku);
    }

    public static function ListProductSKUs($product_id)
    {
        return self::getCollection('/products/' . $product_id . '/skus');
    }
    ...
    public static function createProductSku($id, $object)
    {
        return self::createResource('/products/' . $id . '/skus', $object);
    }

    public static function updateProductSku($product_id, $id, $object)
    {
        return self::updateResource('/products/' . $product_id . '/skus/' . $id, $object);
    }
    ...
    public static function deleteProductSku($product_id, $id)
    {
        return self::deleteResource('/products/' . $product_id . '/skus/' . $id);
    }

    public static function deleteAllProductSku($product_id)
    {
        return self::deleteResource('/products/' . $product_id . '/skus');
    }

    public static function getProductRules($id)
    {
        return self::getCollection('/products/' . $id . '/rules');
    }

    public static function createProductRule($id, $object)
    {
        return self::createResource('/products/' . $id . '/rules', $object);
    }

    public static function updateProductRule($product_id, $id, $object)
    {
        return self::updateResource('/products/' . $product_id . '/rules/' . $id, $object);
    }
    ...
    public static function deleteAllProductRule($product_id)
    {
        return self::deleteResource('/products/' . $product_id . '/rules');
    }

    public static function createProductimage($id, $object)
    {
        return self::createResource('/products/' . $id . '/images', $object);
    }
